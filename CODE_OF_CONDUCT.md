...
- These components are the foundation of CamouChat and should not be submitted for review without thorough local
  testing.
...
- Add changes made should be added in  [CHANGELOG.md](https://github.com/BITS-Rohit/CamouChat/blob/main/CHANGELOG.md)
